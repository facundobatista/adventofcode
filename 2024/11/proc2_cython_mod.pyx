...
cdef class Node:
    ...
    cdef __init__(self, list holder, int idx, int stone):
        self.holder = holder
        self.idx = idx
        self.stone = stone

    cdef set(self, int new_stone):
        self.stone = new_stone

    cdef split(self, int left, int right):
        holder: list[Node] = []
...
cdef go(list stones, int total_blinks):
